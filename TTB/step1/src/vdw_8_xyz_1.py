...
from make_8_xyz_1 import get_monomer_xyzR
from make_8_xyz_1 import get_monomer_xyzR_
...
def vdw_R(A1,A2,A3,theta,dimer_mode,monomer_name):##2分子が接しないようにするにはtheta方向にどれだけずらせばいいのか
    ...
    if dimer_mode=='t':
        monomer_2=get_monomer_xyzR_(monomer_name,Ta=0.,Tb=0.,Tc=0.,A1=-A1,A2=A2,A3=-A3)#convertor(monomer,A1,-A2,-A3+glide)
