...
MONOMER_LIST = ["BTBT","naphthalene","anthracene","tetracene","pentacene","hexacene","perylene"]
############################汎用関数###########################
...
def make_gjf_xyz(auto_dir,monomer_name,params_dict):##R3:t-shaped R4:slipped-parallel
    ...
    monomer_array_ip3 = get_monomer_xyzR(monomer_name,c[0]+a_,c[1],c[2]+R5,-A1,A2,-A3, phi2)
    monomer_array_ip4 = get_monomer_xyzR(monomer_name,c[0]-a_,c[1],c[2]-R5,-A1,A2,-A3, phi2)
    ...
    dimer_array_ip3 = np.concatenate([monomer_array_c1,monomer_array_ip3])##注意
    dimer_array_ip4 = np.concatenate([monomer_array_c1,monomer_array_ip4])##注意
