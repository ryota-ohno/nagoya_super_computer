...
auto_dir='/data/group1/z40145w/Working/nagoya_super_computer/perylene/step2_para/5'
monomer_name='perylene'
#params_dict={'a':11.4,'b':5.3,'theta':40}
params_dict_list=[{'a':9.5,'b':6.5,'theta':31},{'a':9.7,'b':6.3,'theta':32},
                  {'a':9.9,'b':6.2,'theta':33},{'a':10.1,'b':6.1,'theta':34}]
isTest = False
i=0
...
for params_dict in params_dict_list:
    ...
    with open('/data/group1/z40145w/Working/nagoya_super_computer/perylene/step2_para/5/result{}.txt'.format(i),'w')as f:
        for z in z_list1:
            file_basename1 = file_base_name;file_basename2 = file_base_name
