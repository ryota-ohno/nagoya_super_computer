...
auto_dir='/data/group1/z40145w/Working/nagoya_super_computer/perylene/step2_para/6'
monomer_name='perylene'
#params_dict={'a':11.4,'b':5.3,'theta':40}
params_dict_list=[{'a':8.5,'b':7.2,'theta':25},{'a':8.7,'b':7.0,'theta':26},
                  {'a':8.8,'b':7.0,'theta':27},{'a':9.0,'b':6.8,'theta':28},
                  {'a':9.2,'b':6.7,'theta':29},{'a':9.3,'b':6.6,'theta':30},]
isTest = False
i=0
...
for params_dict in params_dict_list:
    ...
    with open('/data/group1/z40145w/Working/nagoya_super_computer/perylene/step2_para/6/result{}.txt'.format(i),'w')as f:
        for z in z_list1:
            file_basename1 = file_base_name;file_basename2 = file_base_name
