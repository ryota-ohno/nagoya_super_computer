...
auto_dir='/data/group1/z40145w/Working/nagoya_super_computer/perylene/step2_para/2/gaussian'
...
file_base_name='perylene_step2_a=7.9_b=7.6_theta=20_'
with open('/data/group1/z40145w/Working/nagoya_super_computer/perylene/step2_para/2/result1.txt','w')as f:
    for z in z_list1:
        ...
        f.write('{} {} {}\n'.format(z,E1,E2))
with open('/data/group1/z40145w/Working/nagoya_super_computer/perylene/step2_para/2/result2.txt','w')as f:
    for z in z_list2:
        file_basename3 = file_base_name
        file_basename3 +='z={}_3.log'.format(z)
        result3=os.path.join(auto_dir,file_basename3)
        E3=get_E1(result3)
        f.write('{} {}\n'.format(z,E3))
