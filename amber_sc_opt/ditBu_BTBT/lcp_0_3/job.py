...
def init_process(args):
    ...
    z_list=[np.round(z,1) for z in np.linspace(0.2,4.0,20)]
    for z in z_list:
        dir_name = f'{z}'
        ...
        '#PJM "--norestart"\n',
        '\n',
        f'python /data/group1/z40145w/Working/nagoya_super_computer/amber_sc_opt/ditBu_BTBT/src/step1_8_xyz_0.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 5\n',
        '\n',
        '#sleep 12 \n'
            ]
