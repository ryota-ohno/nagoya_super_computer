...
def init_process(args):
    ...
    theta_list=[55,56,57,58,59,60,61,62,63,64,65,66,67,68,69,70]
    for theta in theta_list:
        ...
        '#PJM "--norestart"\n',
        '\n',
        f'python /data/group1/z40145w/Working/nagoya_super_computer/amber_sc_opt/BTBT_step3/src/step3_xyz.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name BTBT --num-nodes 1\n',
        '\n',
        '#sleep 5 \n'
            ]
