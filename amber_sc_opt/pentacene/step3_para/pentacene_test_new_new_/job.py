...
def init_process(args):
    ...
    for i in range(75):
        ...
        '#PJM "--norestart"\n',
        '\n',
        f'python /data/group1/z40145w/Working/nagoya_super_computer/amber_sc_opt/pentacene/step3_para/src/step3_xyz_new_new_1.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name pentacene --num-nodes 5\n',
        '\n',
        '#sleep 5 \n'
            ]
