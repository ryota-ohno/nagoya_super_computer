...
import time
from make_xyz_PDI_C8 import exec_gjf##計算した点のxyzfileを出す
...
def main_process(args):
    ...
    shutil.copy(f'/data/group1/z40145w/Working/nagoya_super_computer/amber_sc_opt/PDI/monomer/PDI-C8_mono.frcmod',amber_path)
