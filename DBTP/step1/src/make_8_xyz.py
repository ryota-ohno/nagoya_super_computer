...
MONOMER_LIST = ["DBTP","benzene","naphthalene","anthracene","tetracene","pentacene","hexacene","demo","PTA"]
############################汎用関数###########################
def get_monomer_xyzR(monomer_name,Ta,Tb,Tc,A1,A2,A3,phi=0.0,isFF=False):
    T_vec = np.array([Ta,Tb,Tc])
    df_mono=pd.read_csv('~/Working/nagoya_super_computer/DBTP/monomer/{}1.csv'.format(monomer_name))
