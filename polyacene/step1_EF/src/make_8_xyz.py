...
MONOMER_LIST = ["BTBT","benzene","naphthalene","anthracene","tetracene","pentacene","hexacene","demo"]
############################汎用関数###########################
...
def get_xyzR_lines(xyzR_array,file_description):
    lines = [     
        '%mem=24GB\n',
        '%nproc=42\n',
        '#P TEST b3lyp/6-311G** EmpiricalDispersion=GD3 Force SCF=Tight\n',
        '\n',
        file_description+'\n',
        '\n',
        '0 1\n'
...
def make_xyzfile(monomer_name,params_dict,isInterlayer=False):
    ...
    xyz_list=['400 \n','polyacene9 \n']##4分子のxyzファイルを作成
    monomers_array_4 = np.concatenate([monomer_array_i,monomer_array_p1,monomer_array_p2,monomer_array_t1],axis=0)
