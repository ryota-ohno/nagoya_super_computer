...
def make_gjf_xyz(auto_dir,monomer_name,params_dict):##R3:t-shaped R4:slipped-parallel
    ...
    if a_ > b_:
        ...
        monomer_array_p2 = get_monomer_xyzR(monomer_name,a_,0,2*R3-R4,A1,A2,A3, phi1)##p1がb方向
    ...
    line_list_dimer_t1 = get_xyzR_lines(dimer_array_t1,file_description+'_it1')
