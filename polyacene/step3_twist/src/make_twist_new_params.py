...
def make_gjf_xyz(auto_dir,monomer_name,params_dict):##R3:t-shaped Rt:slipped-parallel
    ...
    if a_ > b_:
        ...
        monomer_array_p2 = get_monomer_xyzR(monomer_name,0,-b_,-2*Rt,A2,A3)##p1がb方向
    else:##a_<b_
        monomer_array_p1 = get_monomer_xyzR(monomer_name,a_,0,0,A2,A3)##p2がa方向
