...
def make_gjf_xyz(auto_dir,monomer_name,params_dict):##R3:t-shaped R4:slipped-parallel
    ...
    if a_ > b_:
        ...
        monomer_array_ip3 = get_monomer_xyzR(monomer_name,c[0],c[1]-b_,c[2]+2*R3-R4,A1,A2,A3, phi1)
    ...
    line_list_dimer_ip3 = get_xyzR_lines(dimer_array_ip3,file_description+'_ip2')
