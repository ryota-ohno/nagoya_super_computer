...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,isInterlayer):
    ...
    monomer_array_i = get_monomer_xyzR(monomer_name,0,0,0,A1,A2,A3, phi1)
    monomer_array_i2 = get_monomer_xyzR(monomer_name,0,0,0,0,0,A3, phi1)
    
    monomer_array_p1 = get_monomer_xyzR(monomer_name,0,b_,Rp,A1,A2,A3, phi1)##p1がb方向
    monomer_array_p3 = get_monomer_xyzR(monomer_name,0,b_,Rp,0,0,A3, phi1)##p1がb方向
    monomer_array_ip1 = get_monomer_xyzR(monomer_name,c[0],c[1]+b_+Rp,c[2],A1,A2,A3, phi1)
    monomer_array_ip2 = get_monomer_xyzR(monomer_name,c[0],c[1]-b_-Rp,c[2],A1,A2,A3, phi1)

    monomer_array_p2 = get_monomer_xyzR(monomer_name,a_,0,2*Rt-Rp,A1,A2,A3, phi1)##p2がa方向
    monomer_array_ip3 = get_monomer_xyzR(monomer_name,c[0]+a_,c[1],c[2]+2*Rt-Rp,A1,A2,A3, phi1)
    monomer_array_ip4 = get_monomer_xyzR(monomer_name,c[0]-a_,c[1],c[2]-2*Rt+Rp,A1,A2,A3, phi1)
    
    monomer_array_i0 = get_monomer_xyzR(monomer_name,c[0],c[1],c[2],A1,A2,A3, phi1)
    monomer_array_t1 = get_monomer_xyzR(monomer_name,a_/2,b_/2,Rt,-A0,A0,-A3, phi2)
    monomer_array_t2 = get_monomer_xyzR(monomer_name,a_/2,-b_/2,Rt-Rp,-A0,A0,-A3, phi2)
    monomer_array_t3 = get_monomer_xyzR(monomer_name,-a_/2,-b_/2,-Rt,-A0,A0,-A3, phi2)
    monomer_array_t4 = get_monomer_xyzR(monomer_name,-a_/2,b_/2,-Rt+Rp,-A0,A0,-A3, phi2)
    monomer_array_it1 = get_monomer_xyzR(monomer_name,c[0]+a_/2,c[1]+b_/2,c[2]+Rt,-A1,A2,-A3, phi2)
    monomer_array_it2 = get_monomer_xyzR(monomer_name,c[0]+a_/2,c[1]-b_/2,c[2]+Rt-Rp,-A1,A2,-A3, phi2)
    monomer_array_it3 = get_monomer_xyzR(monomer_name,c[0]-a_/2,c[1]-b_/2,c[2]-Rt,-A1,A2,-A3, phi2)
    monomer_array_it4 = get_monomer_xyzR(monomer_name,c[0]-a_/2,c[1]+b_/2,c[2]-Rt+Rp,-A1,A2,-A3, phi2)
