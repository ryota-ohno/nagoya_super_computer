...
def main_process(args):
    ...
    if not os.path.exists(auto_csv_path):        
        df_E = pd.DataFrame(columns = ['a','b','theta','Rt','Rp','E','E_t1','E_t2','E_p','machine_type','status','file_name'])##いじる
...
def get_opt_params_dict(df_cur, init_params_dict,fixed_params_dict):
    ...
    Rt = init_params_dict['Rt']; Rp = init_params_dict['Rp']; theta = init_params_dict['theta']
