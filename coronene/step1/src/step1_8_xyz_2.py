...
from make_8_xyz_2 import exec_gjf##計算した点のxyzfileを出す
from vdw_8_xyz_2 import vdw_R##同様
...
def main_process(args):
    ...
    auto_csv_path = os.path.join(auto_dir,'step1.csv')
    if not os.path.exists(auto_csv_path):        
        df_E = pd.DataFrame(columns = ['a','b','theta','Rt','Rp','E','E_p1','E_p2','E_t1','machine_type','status','file_name'])##いじる
